...
import logo from './logo_gelb.png'; // Tell Webpack this JS file uses this image
...
```css
.Logo {
  background-image: url(./logo_gelb.png);
}
```
...
render() {
  ...
  return <img src={process.env.PUBLIC_URL + '/img/logo_gelb.png'} />;
}
```
